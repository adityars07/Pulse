...
export default function RegisterPage() {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-[#f4f2ff] text-slate-800 relative overflow-hidden px-4 py-12">
      ...
      <div className="w-full max-w-md bg-white border border-slate-200 backdrop-blur-xl p-8 rounded-2xl shadow-xl shadow-purple-500/5 relative z-10">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold tracking-tight text-slate-800">Get Started</h1>
          <p className="text-slate-500 text-sm mt-1">Create your tenant account and workspace</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-slate-600 text-sm font-medium mb-1.5" htmlFor="name">
              Full Name
            </label>
            <input
              id="name"
              ...
              className="w-full px-4 py-2 bg-slate-50 border border-slate-200 focus:border-[#7C3AED] rounded-xl focus:outline-none focus:ring-2 focus:ring-[#7C3AED]/10 text-slate-800 placeholder-slate-400 transition-all text-sm"
          ...
          <div>
            <label className="block text-slate-600 text-sm font-medium mb-1.5" htmlFor="workspace">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-2.5 px-4 rounded-xl font-semibold bg-[#7C3AED] hover:bg-[#6D28D9] text-white shadow-lg shadow-purple-500/15 transition-all active:scale-98 flex items-center justify-center gap-2 text-sm disabled:opacity-50 disabled:pointer-events-none mt-2 cursor-pointer"
          >
            {loading ? (
              <>
